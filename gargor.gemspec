...
Gem::Specification.new do |spec|
  ...
  spec.description   = 'An auto-tuning tool for internet servers w/ Genetic Algorithm and Chef. You can get good settings during sleeping ;) '
  spec.summary       = 'It is software which uses generic algorithm to support parameter tuning of the servers controlled by Chef.'
